...
git fetch https://git.openstack.org/openstack/tripleo-heat-templates refs/changes/21/416421/38 && git cherry-pick FETCH_HEAD

# Add docker_puppet_tasks initialization on primary node
git fetch https://git.openstack.org/openstack/tripleo-heat-templates refs/changes/65/426565/8 && git cherry-pick FETCH_HEAD
